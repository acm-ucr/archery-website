  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pt-7 text-center text-5xl font-black md:pt-0 md:text-8xl">
        ...
        <p className="from-archery-yellow-300 to-archery-blue-300 bg-gradient-to-r bg-clip-text pb-7 text-3xl font-black text-transparent md:p-5 md:pt-0 md:text-8xl">
          {subTitle}
        </p>
      </div>
    </div>
