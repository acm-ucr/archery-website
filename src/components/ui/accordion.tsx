...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "border-b border-[#AEC1E7] last:border-b-0",
        "data-[state=open]:bg-[#EBF1FF]",
        "data-[state=open]:border-b-0",
        "data-[state=open]:rounded-xl",
        "data-[state=open]:p-[0.5rem]",
        "data-[state=open]:m-[-0.5rem]",
        className,
      )}
      {...props}
    />
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden bg-[#EBF1FF] text-sm"
      {...props}
    >
